    ...
    return (
        <>
            <React.Fragment>
                ...
                <ListItemButton component={Link} to="/lesson-plans/${planId}">
                    <ListItemIcon>
                        <AnnouncementOutlinedIcon color={location.pathname.startsWith("/Student/lesson-plans/${planId}") ? 'primary' : 'inherit'} />
                    </ListItemIcon>
