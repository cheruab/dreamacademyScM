...
import { removeParentStuff, updateParentFields } from '../../../redux/studentsRelated/parentHandle';
...
const ViewStudents = () => {
    ...
    const removeHandler = (id, deladdress) => {
        dispatch(removeParentStuff(id, deladdress))
            .then(() => {
                dispatch(getUserDetails(studentID, address));
            })
    }
    ...
    const removeSubAttendance = (subId) => {
        dispatch(updateParentFields(studentID, { subId }, "RemoveStudentSubAtten"))
            .then(() => {
                dispatch(getUserDetails(studentID, address));
            })
    }
        ...
        return (
            <>
                {subjectMarks && Array.isArray(subjectMarks) && subjectMarks.length > 0
                    ...
                    :
                    <Button variant="contained" sx={styles.styledButton} onClick={() => navigate("/Admin/parents/parent/marks/" + studentID)}>
                        Add Marks
                    </Button>
                }
            </>
